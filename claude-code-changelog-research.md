# Claude Code changelog research

Sources fetched: official docs changelog (redirected to https://code.claude.com/docs/en/changelog), GitHub CHANGELOG.md (https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md), GitHub releases API, npm registry publish times for @anthropic-ai/claude-code.

Latest npm version: 2.1.159 (stable: 2.1.150).

Parsed 303 CHANGELOG.md entries. Dates are npm publish dates where available.
...
### 0.2.82 — date not found

- Added support for --disallowedTools
- Renamed tools for consistency: LSTool -> LS, View -> Read, etc.

### 0.2.75 — date not found
...
### 0.2.26 — date not found

- New /approved-tools command for managing tool permissions
- Word-level diff display for improved code readability
- Fuzzy matching for slash commands

### 0.2.21 — date not found
